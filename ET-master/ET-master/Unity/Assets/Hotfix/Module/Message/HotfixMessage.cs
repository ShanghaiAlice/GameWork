...
namespace ETHotfix {
  ...
  public partial class C2R_Login : pb::IMessage {
    ...
    public partial class C2R_Register : pb::IMessage
    {
        ...
        private string passwordAgain_ = "";

        public string PasswordAgain
        {
            get { return passwordAgain_; }
            set
            {
                passwordAgain_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
            }
        }
        ...
        public void WriteTo(pb::CodedOutputStream output)
        {
            ...
            {
                output.WriteRawTag(30);
                output.WriteString(PasswordAgain);
            }
        }
        ...
        public int CalculateSize()
        {
            ...
            if (PasswordAgain.Length != 0)
            {
                size += 1 + pb::CodedOutputStream.ComputeStringSize(PasswordAgain);
            }
            return size;
        }
        ...
        public void MergeFrom(pb::CodedInputStream input)
        {
            ...
            while ((tag = input.ReadTag()) != 0)
            {
                switch (tag)
                {
                    ...
                    case 30:
                        {
                            PasswordAgain = input.ReadString();
                            break;
                        }
                    case 720:
                        {
    ...
    public partial class C2G_RegisterGate : pb::IMessage {
    private static readonly pb::MessageParser<C2G_RegisterGate> _parser = new pb::MessageParser<C2G_RegisterGate>(() => (C2G_RegisterGate)MessagePool.Instance.Fetch(typeof(C2G_RegisterGate)));
    public static pb::MessageParser<C2G_RegisterGate> Parser { get { return _parser; } }
    ...
    public partial class G2C_RegisterGate : pb::IMessage
    {
        private static readonly pb::MessageParser<G2C_RegisterGate> _parser = new pb::MessageParser<G2C_RegisterGate>(() => (G2C_RegisterGate)MessagePool.Instance.Fetch(typeof(G2C_RegisterGate)));
        public static pb::MessageParser<G2C_RegisterGate> Parser { get { return _parser; } }
