...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_RpcException_Binding
    {
        ...
        static StackObject* get_Error_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.RpcException instance_of_this_method = (ETModel.RpcException)typeof(ETModel.RpcException).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
